/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 66133371ea89627fcf53eece7661af2b)
// Runtime types generated with workerd@1.20251011.0 2025-07-12 nodejs_compat_v2
declare namespace Cloudflare {
  ...
  interface Env {
    ...
    // Bindings
    UPLOADS_R2: R2Bucket;
    DI_CACHE_KV: KVNamespace;
    JOB_STATUS_DO: DurableObjectNamespace;

    // Workflows binding (type depends on platform; keep as any to avoid compile mismatch)
    WBS_WORKFLOW: any;

    // Azure DI
    DI_BACKEND_URL: string;
    DI_MODEL: string;
    DI_BACKEND_VERSION: string;
    DI_CACHE_TTL_SECONDS: string;
    DI_CACHE_ENABLED: string;

    // Mongo Data API
    MONGO_DATA_API_URL: string;
    MONGO_DATA_API_KEY_HEADER: string;
    MONGO_DATA_API_DB: string;
    MONGO_DATA_API_SOURCE: string;
    MONGO_COLL_JOBS: string;
    MONGO_COLL_NODES: string;
    MONGO_COLL_ARTIFACTS: string;

    MONGO_DATA_API_KEY: string; // secret

    // LLM defaults
    LLM_DEFAULT_EXTRACT_PROVIDER: string;
    LLM_DEFAULT_VERIFY_PROVIDER: string;
    LLM_DEFAULT_JUDGE_PROVIDER: string;
